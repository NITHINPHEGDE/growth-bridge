          ...
          {services.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative rounded-2xl p-6 cursor-pointer transition-shadow duration-300 ${
                  isNavy
              ...
              >
                <div className={`w-11 h-11 rounded-xl flex items-center justify-center mb-4 transition-transform group-hover:scale-110 ${
                  isNavy ? 'bg-[#2d7a3a]/20' : 'bg-[#0d1b3e]/5'
                }`}>
                ...
                <div className={`mt-4 w-7 h-7 rounded-full flex items-center justify-center transition-all duration-200 group-hover:opacity-100 opacity-0 group-hover:translate-x-0 -translate-x-2 ${
                  isNavy ? 'bg-[#2d7a3a]' : 'bg-[#0d1b3e]'
                }`}>
